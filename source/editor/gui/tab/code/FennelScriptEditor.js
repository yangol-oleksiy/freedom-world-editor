...
import {FennelToolbar} from "./controls/FennelToolbar.js";

/**
 * The script editor is used to view and edit code of script objects.
 *
 * @class FennelScriptEditor
 * @extends {CodeEditor}
 */
function FennelScriptEditor(parent, closeable, container, index)
{
	CodeEditor.call(this, parent, closeable, container, index);

	var self = this;

	this.setLanguage("commonlisp");
	this.updateSettings();
	 ...
	 * @type {FennelToolbar}
	 */
	this.toolBar = new FennelToolbar(this);
...
FennelScriptEditor.prototype = Object.create(CodeEditor.prototype);

FennelScriptEditor.prototype.updateMetadata = function()
{
	// Name
...
FennelScriptEditor.prototype.activate = function()
{
...
FennelScriptEditor.prototype.isAttached = function(script)
{
	return this.script === script;
};

FennelScriptEditor.prototype.attach = function(script)
{
	this.script = script;
 ...
 * @method updateCode
 */
FennelScriptEditor.prototype.updateCode = function()
{
	if (this.script !== null)
	{
...
FennelScriptEditor.prototype.updateSize = function()
{
